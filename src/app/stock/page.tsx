...
const stockItems: StockItem[] = initialProducts.map((p: any) => ({
  id: String(p.id),
  sku: p.sku,
  name: p.name,
  category: p.category,
  ...
  minStock: 5,
  maxStock: 50,
  sold30d: p.soldMonthly,
  status: p.stock === 0 ? 'out' : (p.stock <= 5 ? 'low' : 'ok')
}))

const movements: Movement[] = [
  { id: 'm1', product: 'iPhone 15 128GB', sku: 'IPH-15-128', type: 'entrada', qty: 10, date: '09/04/2026 11:30', user: 'Lucas M.', note: 'Reposicion proveedor' },
  { id: 'm2', product: 'iPhone 16 Pro 128GB', sku: 'IPH-16P-128', type: 'salida', qty: 2, date: '09/04/2026 10:15', user: 'Sofia R.', note: 'Venta #1042' },
  { id: 'm3', product: 'iPhone 13 128GB R', sku: 'IPH-13-128-R', type: 'ajuste', qty: -1, date: '08/04/2026 17:20', user: 'Lucas M.', note: 'Ajuste inventario' },
]
