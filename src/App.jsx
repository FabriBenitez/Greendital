...
import { brands, categories, initialCustomers, initialProducts, paymentMethods } from './showcase/data'
...
function ProductCard({ product, onAddToCart, onWhatsapp, whatsappNumber }) {
  ...
  return (
    <article className="glass-panel product-card">
      <div className="product-image-container" style={{ height: '180px', borderRadius: '12px', overflow: 'hidden', marginBottom: '1rem', background: 'rgba(0,0,0,0.05)' }}>
      ...
      <main className="main-grid">
        ...
        <section id="productos" className="panel-section">
          <SectionHeader
            ...
            title="Inventario de iPhones y Apple Ecosystem."
            text="Gestion centralizada de equipos nuevos, reacondicionados y accesorios con control de margen."
          >
            <label className="search-box">
              <span>Buscar iPhone, Funda o SKU</span>
              <input
                type="search"
                value={search}
                onChange={(event) => setSearch(event.target.value)}
                placeholder="Ej: iPhone 15 / Pro Max / Reacondicionado"
              />
            </label>
          </SectionHeader>
              ...
              <div className="phone-screen">
                ...
                <label className="search-box mobile-search">
                  <input
                    ...
                    placeholder="Buscar iPhone, Audio, Fundas..."
                  />
                </label>
